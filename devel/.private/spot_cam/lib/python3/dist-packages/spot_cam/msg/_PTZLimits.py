...
"""autogenerated by genpy from spot_cam/PTZLimits.msg. Do not edit."""
import codecs
import sys
...
class PTZLimits(genpy.Message):
  _md5sum = "b3ee9ed25575b46bb47c7673ad202faa"
  _type = "spot_cam/PTZLimits"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# https://dev.bostondynamics.com/protos/bosdyn/api/proto_reference#ptzdescription-limits
...
float32 max"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PTZLimits, self).__init__(*args, **kwds)
