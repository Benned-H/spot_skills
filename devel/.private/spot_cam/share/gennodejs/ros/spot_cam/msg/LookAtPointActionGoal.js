...
class LookAtPointActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LookAtPointGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += LookAtPointGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LookAtPointActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = LookAtPointGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new LookAtPointGoal()
    }
...
module.exports = LookAtPointActionGoal;
