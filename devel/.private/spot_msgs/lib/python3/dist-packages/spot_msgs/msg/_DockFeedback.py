...
"""autogenerated by genpy from spot_msgs/DockFeedback.msg. Do not edit."""
import codecs
import sys
...
class DockFeedback(genpy.Message):
  _md5sum = "c362c4f04a7060b16832e7c8aadb5896"
  _type = "spot_msgs/DockFeedback"
...
uint8 power_status"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.status is None:
        self.status = spot_msgs.msg.DockState()
    else:
      self.status = spot_msgs.msg.DockState()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2BIB().pack(_x.status.status, _x.status.dock_type, _x.status.dock_id, _x.status.power_status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.status.status, _x.status.dock_type, _x.status.dock_id, _x.status.power_status,) = _get_struct_2BIB().unpack(str[start:end])
      return self
