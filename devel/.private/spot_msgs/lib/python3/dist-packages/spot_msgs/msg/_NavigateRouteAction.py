...
"""autogenerated by genpy from spot_msgs/NavigateRouteAction.msg. Do not edit."""
import codecs
import sys
...
class NavigateRouteAction(genpy.Message):
  _md5sum = "4c1d74a967d22d6f41d55f3a9117c255"
  _type = "spot_msgs/NavigateRouteAction"
...
"""
  ...
  _slot_types = ['spot_msgs/NavigateRouteActionGoal','spot_msgs/NavigateRouteActionResult','spot_msgs/NavigateRouteActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NavigateRouteAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = spot_msgs.msg.NavigateRouteActionGoal()
      if self.action_result is None:
        self.action_result = spot_msgs.msg.NavigateRouteActionResult()
      if self.action_feedback is None:
        self.action_feedback = spot_msgs.msg.NavigateRouteActionFeedback()
    else:
      self.action_goal = spot_msgs.msg.NavigateRouteActionGoal()
      self.action_result = spot_msgs.msg.NavigateRouteActionResult()
      self.action_feedback = spot_msgs.msg.NavigateRouteActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.waypoint_ids)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.waypoint_ids:
        length = len(val1)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.waypoint_ids = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.waypoint_ids.append(val1)
      _x = self
      start = end
      end += 12
