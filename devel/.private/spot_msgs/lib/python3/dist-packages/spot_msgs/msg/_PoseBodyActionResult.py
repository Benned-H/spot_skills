...
"""autogenerated by genpy from spot_msgs/PoseBodyActionResult.msg. Do not edit."""
import codecs
import sys
...
class PoseBodyActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "spot_msgs/PoseBodyActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','spot_msgs/PoseBodyResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PoseBodyActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = spot_msgs.msg.PoseBodyResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = spot_msgs.msg.PoseBodyResult()
