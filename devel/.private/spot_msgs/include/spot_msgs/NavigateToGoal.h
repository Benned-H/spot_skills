...
{
  return lhs.navigate_to == rhs.navigate_to;
}
...
struct MD5Sum< ::spot_msgs::NavigateToGoal_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x21ae8f84643ff7c2ULL;
  static const uint64_t static_value2 = 0xf08b8a6d6567f4ffULL;
};
