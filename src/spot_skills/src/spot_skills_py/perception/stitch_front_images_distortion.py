...
def get_image_from_robot(robot, jpeg_quality_percent=90):
    ...
    image_response = image_client.get_image_async(requests, timeout=5.0)
...
def main():
    ...
    image_response = get_image_from_robot(robot, jpeg_quality_percent=90)
    stitch(image_response)
