...
class PoseEstimateClient:
    ...
    def __init__(
        ...
        cameras_list_str = str(rospy.get_param("/pose_estimation/default_cameras"))
    ...
    def call_pose_estimation(self, object_name: str) -> None:
        ...
        rgbd_pairs: list[RGBDPair] = rgbd_pairs_msg.rgbd_pairs

        camera_poses: dict[str, Pose3D] = {}
        for camera_name, rgbd_pair in zip(self.camera_names, rgbd_pairs):
